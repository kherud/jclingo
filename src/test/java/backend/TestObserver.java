...
//            Assert.assertTrue(called.contains("rule"));
            WeightedLiteral[] weightedLiterals = (WeightedLiteral[]) new WeightedLiteral().toArray(2);
            weightedLiterals[1] = new WeightedLiteral();
            weightedLiterals[0].literal = 2;
            weightedLiterals[0].weight = 3;
            weightedLiterals[1].literal = 4;
            weightedLiterals[1].weight = 5;
...
//        Assert.assertTrue(choice);
    ...
    public boolean weightRule(boolean choice, Pointer head, NativeSize headSize, int lowerBound, Pointer body, NativeSize bodySize, Pointer data) {
        ...
        Assert.assertEquals(headAtoms, new int[]{2});
        // TODO: test for weighted literals
        Assert.assertEquals(bodyAtoms, new int[]{2});
