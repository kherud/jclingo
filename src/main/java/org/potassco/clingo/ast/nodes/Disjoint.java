...
public class Disjoint extends Ast {

    public Disjoint(Pointer ast) {
        super(ast);
    }
    
    public Disjoint(Location location, AstSequence elements) {
    ...
    private static Pointer create(Location location, AstSequence elements) {
        ...
        Clingo.check(Clingo.INSTANCE.clingo_ast_build(AstType.DISJOINT.ordinal(), pointerByReference, location, elements.getPointer(), new NativeSize(elements.size())));
